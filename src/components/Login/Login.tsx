    ...
    return (
        <section className="flex flex-col-reverse lg:flex-row justify-center items-center gap-24 md:flex-col min-h-screen bg-[#E0E0E0]">
            ...
            <form className="w-10/12 lg:w-4/12 flex flex-col bg-white p-6 rounded-2xl">
                <h3 className="text-2xl md:text-4xl lg:text-5xl font-semibold text-[#101828] text-center mb-12">Login</h3>
                ...
                <div className="flex justify-center mt-6">
                    <button type="submit" className="text-white py-2 px-4 rounded-xl text-xl bg-green-500">Entrar</button>
                </div>
                <p className="text-center mt-6 text-[#313131] font-semibold text-lg">Não possui uma conta?<Link href="/cadastro" className="text-black"> Cadastre-se</Link></p>
